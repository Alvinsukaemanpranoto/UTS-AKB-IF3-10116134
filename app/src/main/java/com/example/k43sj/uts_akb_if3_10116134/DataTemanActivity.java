...
public class DataTemanActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        models.add(new Mahasiswa(R.drawable.person_dummy, "10116135", "Rival","IF-3","08112004240","rafli060392@gmail.com","rafli_rach"));
        ...
        models.add(new Mahasiswa(R.drawable.person_dummy, "10116111", "Aditya Nug","IF-3","081312923780","rafli060392@gmail.com","rafli_rach"));
        findViewById(R.id.fab).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DataTemanActivity.this, TambahDataTeman.class);
                models.add(new Mahasiswa(R.drawable.person_dummy, "10116111", "Aditya Nug","IF-3","081312923780","rafli060392@gmail.com","AdityaNug"));
